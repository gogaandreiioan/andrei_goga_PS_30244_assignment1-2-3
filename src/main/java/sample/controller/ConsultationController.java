...
/**
 * ConsultationFormController is  managing the endpoints those are making CRUD on Consultation table
 * using PatientService ,ConsultationService and UseService interfaces.
 * Please see the {@link javadoc.patientDto} class for true identity
 * @author Goga Andrei
 *
 */
